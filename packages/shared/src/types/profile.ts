...
export const BG_SVG_PATTERN_META: Record<BgSvgPatternId, { label?: string; file: string; size: string }> = {
  ...
  "svg-pattern0499": { file: "svg-pattern0499.svg", size: "128px 131px" },
  "svg-pattern0507": { file: "svg-pattern0507.svg", size: "128px 128px" },
  "svg-pattern0517": { file: "svg-pattern0517.svg", size: "128px 220px" },
  "svg-pattern0527": { file: "svg-pattern0527.svg", size: "128px 93px" },
  "svg-pattern0539": { file: "svg-pattern0539.svg", size: "128px 148px" },
  "svg-pattern0563": { file: "svg-pattern0563.svg", size: "128px 128px" },
  "svg-pattern0586": { file: "svg-pattern0586.svg", size: "128px 128px" },
  "svg-pattern0589": { file: "svg-pattern0589.svg", size: "128px 148px" },
  "svg-pattern0590": { file: "svg-pattern0590.svg", size: "128px 273px" },
  "svg-pattern0595": { file: "svg-pattern0595.svg", size: "128px 111px" },
  "svg-pattern0597": { file: "svg-pattern0597.svg", size: "128px 128px" },
  "svg-pattern0598": { file: "svg-pattern0598.svg", size: "128px 101px" },
  "svg-pattern0609": { file: "svg-pattern0609.svg", size: "128px 128px" },
  "svg-pattern0611": { file: "svg-pattern0611.svg", size: "128px 126px" },
  "svg-pattern0617": { file: "svg-pattern0617.svg", size: "128px 128px" },
  "svg-pattern0634": { file: "svg-pattern0634.svg", size: "128px 128px" },
  "svg-pattern0636": { file: "svg-pattern0636.svg", size: "128px 111px" },
  "svg-pattern0638": { file: "svg-pattern0638.svg", size: "128px 128px" },
};
